    ...
    {        // 아이템 기본 클래스
        ...
        public static List<Item> CreateDefaultItems()
        {
            return new List<Item>
            {
                ...
                new Item("검", "기본 공격력 25, 크리티컬 확률 2, 크리티컬 데미지 20 증가", ItemType.Weapon, 25, 0, 0, 0, 0, 0.2, 20),
                new Item("단검", "기본 공격력 35,크리티컬 확률 5, 크리티컬 데미지 35 증가", ItemType.Weapon, 35, 0, 0, 0, 0, 0.5, 35),
                new Item("활", "기본 공격력 30 크리티컬 확률 3, 크리티컬 데미지 30 증가", ItemType.Weapon, 30, 0, 0, 0, 0, 0.3, 30),
                new Item("지팡이", "기본 공격력 25 크리티컬 확률3, 크리티컬 데미지 25 증가", ItemType.Weapon, 25, 0, 0, 0, 0, 0.3, 25),
